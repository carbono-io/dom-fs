...
var DomFile = function (filePath) {
    ...
    var options = {
        extraMethods: {
            notifyUpdate: this.emit.bind(this, 'update'),
        },
    };

    var dom = buildDom(contents, options);

    this.dom = dom;
    EventEmitter.call(this);
};

util.inherits(DomFile, EventEmitter);

DomFile.prototype.getElementByCharPosition = function (charPosition) {
    console.log(charPosition);
};

DomFile.prototype.getElementByUuid = function (uuid) {
    // We can later create a dict of all tag elements, by their uuids.
