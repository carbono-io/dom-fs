 ...
 */
elementMethods.removeChild = function (element) {

    if (!_.isObject(element)) {
        throw new TypeError('Expected Object, got ' + typeof element);
    }
    if (element.parent !== this) {
        throw new Error('Parameter not a child of current element.');
    }

    this.children.splice(this._getChildIndex(element), 1);
 ...
 */
elementMethods.removeSelf = function () {
